...
public static double add1(double a) {
	    ...
	    return 10.0000000000000 * Math.floor(0.0769230769230769 * Math.max(500.000000000000, 10080.0000000000 + 0.000480000000000000 * pl + -9599.70000000000 * Math.pow(0.995000000000000, -1.00000000000000 + pl + -1.00000000000000 * m) + -0.000480000000000000 * m));
	};
